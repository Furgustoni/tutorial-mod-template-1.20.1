...
import net.furgus.furgusmenagerie.world.tree.LeekSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block LEEK_SAPLING = Registry.register(Registries.BLOCK, Identifier.of(FurgusMod.MOD_ID, "leek_sapling"),
            new SaplingBlock (new LeekSaplingGenerator (), FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
